...
# spring 실행 후 로그 쌓는거 확인
$ cat logback.log | nc -c localhost 5000

$ docker exec -u 0 -it docker-elk_logstash_1 bash
$ su -
$ apt-get update
...
$ tail -f /tmp/my_logstash.log


# 네트워크 정보, 볼륨, 컨테이너 일괄 정지 및 삭제
